# Problem Set 2: Part-of-speech tagging with an HMM and an LSTM
...
Clone your repo down to your own machine. You will find two directories: `hmm` and `lstm`. 

## Part 1: Comparing most frequent POS tagging approach with HMM tagger
In the `hmm` directory you'll find some data files and a python program called `viterbi.py`. You will be writing your code for this part of the problem set in the `viterbi.py` files.
